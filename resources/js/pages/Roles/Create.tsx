                    ...
                    <div className="space-y-8">
                        ...
                        <div className="flex items-start justify-between">
                            <div className="space-y-1">
                                <h1 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">Create New Role</h1>
                                <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">Define a new role and configure its permissions across the system</p>
                            </div>
